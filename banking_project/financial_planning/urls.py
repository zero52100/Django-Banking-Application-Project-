...
from .views import SavingsGoalCreateAPIView, SavingsGoalDetailsAPIView, SavingsGoalListAPIView,BudgetDetailsAPIView, ExpenseDetailsAPIView, BudgetCreateAPIView, ExpenseCreateAPIView ,BudgetListAPIView  ,ExpenseListAPIView
...
urlpatterns = [
    ...
    path('budget/list/', BudgetListAPIView.as_view(), name='budget-list'),
    ...
    path('expense/list/', ExpenseListAPIView.as_view(), name='expense-list'),
]
